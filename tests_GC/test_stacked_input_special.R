...
skim(salary_benefit_table_s %>% filter(class == "special"))
...
skim(ann_factor_table_s %>% filter(employee_class == "special"))
...
skim(benefit_table_s %>% filter(employee_class == "special"))
