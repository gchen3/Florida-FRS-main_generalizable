...
get_wf_term_df_final_s <- function(wf_term_df_s, benefit_val_table_s, benefit_table_s, params) {
...
get_wf_refund_df_final_s <- function(wf_refund_df_s, benefit_table_s, params) {
...
get_wf_retire_df_final_s <- function(wf_retire_df_s, benefit_table_s, ann_factor_table_s, params) {
...
get_liability_data_s <- function(
  ...
  ann_factor_table_s <- bf_data_env$benefit_data_s$ann_factor_table_s
  ann_factor_retire_table_s <- bf_data_env$benefit_data_s$ann_factor_retire_table_s
